...
void Tir::creationTir(Texture texture_Tour, int posTourX, int posTourY, const Vector2f posEnnemi, int vitesse, int zone) throw(string)
{
...
void Tir::creerTir(string nomTexture, string nomTexture_2, string nomTexture_3, string nomTexture_4, string nomTexture_5)
{
    if (!m_texture[0].loadFromFile(nomTexture)){cout << "Tir.cpp : Impossible de charger : " << nomTexture << endl;}
    m_nbTexture = 1;
